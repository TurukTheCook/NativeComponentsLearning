class TurukPoll extends HTMLElement {
  constructor() {
    super();
  ...
  connectedCallback() {
    ...
    this._root.innerHTML = `
      <style>
        .turuk-poll-container {
          background-color: #333;
        }
        .turuk-poll-container h3 {
          margin: 0;
          padding: 0 20px;
          color: #FFF;
          line-height: 50px;
        }
        .turuk-poll-container ul {
          list-style: none;
          margin: 0;
          padding: 0;
        }
        .turuk-poll-container ul li {
          padding: 0 20px;
          line-height: 50px;
        ...
        .turuk-poll-container ul li:hover {
          background-color: #CCC;
        }
        .turuk-poll-container ul li.selected {
          background-color: #5cb85c;
          color: #FFF;
        }
      </style>
      <div class="turuk-poll-container">
        <h3 id="question"></h3>
        <ul id="answers"></ul>
      </div>
    `;
...
window.customElements.define("turuk-poll", TurukPoll);